      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm font-medium">
            ...
            <li><Link to="/disena-tu-vaso" className="hover:text-blue-600 transition-colors">Personalizador Vaso</Link></li>
          </ul>
        </div>
        <div>
          <h3 className="font-bold text-slate-800 mb-4 uppercase tracking-wider text-sm">Ejecutivo Comercial</h3>
          <p className="text-sm mb-2"><span className="font-semibold">Email:</span> ventas@plastitaps.com</p>
          <p className="text-sm mb-4"><span className="font-semibold">Tel:</span> +52 (33) 3575 0197</p>
          <Link to="/catalogo">
